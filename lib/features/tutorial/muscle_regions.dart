  ...
  static final List<MuscleRegion> _front = <MuscleRegion>[
    MuscleRegion(
      ...
      pathBuilder: (Size s) => Path.combine(
        ...
        _tiltedRectN(
          s,
          const Rect.fromLTWH(0.16, 0.23, 0.12, 0.28),
          _kArmTiltRad,
        ),
        _tiltedRectN(
          s,
          const Rect.fromLTWH(0.75, 0.23, 0.12, 0.28),
          -_kArmTiltRad,
        ),
      ),
    ),
    ...
    MuscleRegion(
      id: MuscleId.chest,
      side: BodySide.front,
      pathBuilder: (Size s) => _polyN(s, const <Offset>[
        Offset(0.38, 0.18),
        Offset(0.62, 0.18),
        Offset(0.68, 0.28),
        Offset(0.32, 0.28),
    ...
    MuscleRegion(
      ...
      side: BodySide.front,
      pathBuilder: (Size s) =>
          _rectN(s, const Rect.fromLTWH(0.42, 0.28, 0.16, 0.20)),
    ),
    MuscleRegion(
      id: MuscleId.legs,
      side: BodySide.front,
  ...
  static final List<MuscleRegion> _back = <MuscleRegion>[
    MuscleRegion(
      ...
      pathBuilder: (Size s) => Path.combine(
        ...
        _tiltedRectN(
          s,
          const Rect.fromLTWH(0.14, 0.23, 0.13, 0.28),
          _kArmTiltRad,
        ),
        _tiltedRectN(
          s,
          const Rect.fromLTWH(0.73, 0.23, 0.13, 0.28),
          -_kArmTiltRad,
        ),
      ),
    ),
    ...
    MuscleRegion(
      ...
      side: BodySide.back,
      pathBuilder: (Size s) =>
          _rectN(s, const Rect.fromLTWH(0.40, 0.44, 0.20, 0.10)),
    ),
    MuscleRegion(
      id: MuscleId.legs,
      side: BodySide.back,
